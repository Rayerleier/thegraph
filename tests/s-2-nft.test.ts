...
import { Transfer as TransferEvent } from "../generated/s2NFT/s2NFT"
import { handleTransfer } from "../src/s-2-nft"
import { createTransferEvent } from "./s-2-nft-utils"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newTransferEvent = createTransferEvent(_from, _to, _tokenId)
